...
* Высокая предопределенность: только один удар; никогда нет удара одной рукой; удар не может быть изменен, после того как начат; необходим удар, а не порез; движение всегда начинается с _tsugi ashi_.
...
- **Ushiro kubi shime**
- **Mae otoshi** - обращаем внимание на тайминг и то, что после удара _uke_ пытается поднять меч снова (возвратное движение)
